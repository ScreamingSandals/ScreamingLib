package org.screamingsandals.lib.bukkit.gamecore.utils;
...
import org.screamingsandals.lib.gamecore.utils.FakeDeath;
...
public class BukkitFakeDeath<G extends Game<G, P, ?>, P extends GamePlayer<P, G>> implements FakeDeath<G, P> {
    @Override
    public void die(P gamePlayer) {
