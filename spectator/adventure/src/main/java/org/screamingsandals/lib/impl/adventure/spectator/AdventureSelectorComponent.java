...
public class AdventureSelectorComponent extends AdventureComponent implements SelectorComponent {
    ...
    public SelectorComponent.@NotNull Builder toBuilder() {
        if (AdventureFeature.BUILDABLE_COMPONENT_REMOVAL.isSupported()) {
            ...
            return new AdventureSelectorBuilder((net.kyori.adventure.text.SelectorComponent.Builder) ComponentBuilderCompat.toBuilder(wrappedObject));
        }
    }
    ...
    public static class AdventureSelectorBuilder extends AdventureBuilder<
        ...
        public AdventureSelectorBuilder(net.kyori.adventure.text.SelectorComponent.@NonNull Builder builder) {
            super(builder);
        }
