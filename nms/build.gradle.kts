...
class SlibNamingStrategy(accessorPackage: String)
    : ForwardingNamingStrategy(StandardNamingStrategies.SEMI_QUALIFIED.prefixed(accessorPackage)) {
    companion object {
        @JvmStatic
    ...
    override fun constant(model: FieldAccessor, index: Int): String {
        val fieldName = "CONST_${model.upperName}"
        return if (index != 0) "${fieldName}_$index" else fieldName
    }
}
...
accessors {
    ...
    namingStrategy(SlibNamingStrategy("org.screamingsandals.lib.impl.nms.accessors"))
...
//        method(it.name, 'parse', String::class) // 1.21+ // TODO: uncomment when needed in modern versions
    ...
    val Component = mapClass("net.minecraft.network.chat.Component") {
        getter(String::class, "coloredString") //method String, 'func_150254_d' // get legacy string
    }
    mapClass("net.minecraft.network.chat.ComponentSerialization") {
        field("com.mojang.serialization.Codec", "CODEC")
    }

    val EntityType = mapClass("net.minecraft.world.entity.EntityType") {
        method("java.util.Optional", "byString", String::class) // 1.14+
        method("net.minecraft.entity.EntityType", "func_200713_a", String::class) // 1.13.X, Searge mapped
        ...
        field("java.util.Map", "field_75624_e") // <= 1.10.2, Searge mapped

        field("java.util.Map", "field_75625_b") // <= 1.10.2 - map from string to class type, Searge mapped
        method("java.lang.Class", "func_201760_c") // 1.13.X - entity class type, Searge mapped
    ...
    mapClass("net.minecraft.core.MappedRegistry") {
        methodInferred("func_148757_b", "1.8.8", "java.lang.Object") // <= 1.13
    ...
    var SynchedEntityData = mapClass("net.minecraft.network.syncher.SynchedEntityData") {
        method("void", "watch", "int", "java.lang.Object") // 1.8.8 compat - bossbar - 1.8.8 ONLY method
    }

    var Entity = mapClass("net.minecraft.world.entity.Entity") {
        getter(SynchedEntityData, "entityData") // DataWatcher
        methodChain {
            item("net.minecraft.world.level.Level", "getCommandSenderWorld")
            item("net.minecraft.world.level.Level", "level")
        }
        setter("boolean", "invisible")
        getter("boolean", "invisible")
        setter(String::class, "customName")
        setter(Component, "customName")
        method("void", "absSnapTo", "double", "double", "double", "float", "float")
        method("boolean", "startRiding", this.name, "boolean")
        method("void", "stopRiding")
        field("int", "entityCount")
        field("java.util.concurrent.atomic.AtomicInteger", "ENTITY_COUNTER")
    }
    ...
    mapClass("net.minecraft.network.chat.Component\$Serializer") {
        ...
        methodChain {
            item("net.minecraft.network.chat.MutableComponent", "fromJson", String::class) // 1.16.1 - 1.20.5
            item(Component, "fromJson", String::class) // up to 1.15.2
        }
    ...
    var Goal = mapClass("net.minecraft.world.entity.ai.goal.Goal") {
        ...
        getter("java.util.EnumSet", "flags") // >= 1.14
    }
    ...
    mapClass("net.minecraft.world.entity.ai.goal.GoalSelector") {
        field("java.util.Set", "availableGoals") // 1.14+
        fieldChain {
            item("java.util.List", "field_75782_a")
            item("java.util.Set", "field_75782_a") // 1.8.8
        }
    ...
    mapClass("net.minecraft.world.entity.ai.goal.MeleeAttackGoal") {
        constructor("net.minecraft.world.entity.PathfinderMob", "double", "boolean")
    }
    ...
    mapClass("net.minecraft.world.entity.ai.goal.RandomStrollGoal") {
        constructor("net.minecraft.world.entity.PathfinderMob", "double")
    }
    ...
    mapClass("net.minecraft.world.entity.ai.goal.target.HurtByTargetGoal") {
        constructor("net.minecraft.world.entity.PathfinderMob", "java.lang.Class[]") // 1.14+
        constructor("net.minecraft.server.VVV.EntityCreature", "boolean", "java.lang.Class[]") // <= 1.13.2, Spigot mapped
    }
    ...
    var FriendlyByteBuf = mapClass("net.minecraft.network.FriendlyByteBuf") {
        ...
        var frByteBuf = this.name
        methodChain {
            item(frByteBuf, "writeNbt", "net.minecraft.nbt.Tag") // 1.20.2+, it's just more lenient, we use it with CompoundTag anyways
            item(frByteBuf, "writeNbt", "net.minecraft.nbt.CompoundTag") // <= 1.20.1
            item("void", "func_150786_a", "net.minecraft.nbt.NBTTagCompound") // 1.8.8, Searge mapped
        }
    }
    ...
    mapClass("net.minecraft.network.protocol.common.ClientboundCustomPayloadPacket") { // <= 1.20.1 known as game.ClientboundCustomPayloadPacket; 1.20.2+ new name
        constructor(String::class, "net.minecraft.server.VVV.PacketDataSerializer") // pre-1.13, Spigot mapped
        constructor("net.minecraft.resources.ResourceLocation", FriendlyByteBuf) // 1.13+
    }
    ...
    mapClass("net.minecraft.network.protocol.game.ClientboundUpdateMobEffectPacket") {
        field("int", "entityId") // TODO: This field is required by SBA, not Slib; accessor generation for this field should be moved to SBA repository
    }
    mapClass("net.minecraft.network.protocol.game.ClientboundSetEquipmentPacket") {
        field("int", "entity") // TODO: This field is required by SBA, not Slib; accessor generation for this field should be moved to SBA repository
    }
    ...
    // Titles <= 1.16.5
    var ClientboundSetTitlesPacket_Type = mapClass("net.minecraft.network.protocol.game.ClientboundSetTitlesPacket\$Type") {
        enumConstant("TITLE")
    ...
    var ServerboundInteractPacket_Action = mapClass("net.minecraft.network.protocol.game.ServerboundInteractPacket\$Action") {
        enumConstant("ATTACK")
    }
    ...
    var ServerStatus_Version = mapClass("net.minecraft.network.protocol.status.ServerStatus\$Version") {
    ...
    var ServerStatus = mapClass("net.minecraft.network.protocol.status.ServerStatus") {
        getter(ServerStatus_Version, "version") // -1.19.3
    ...
    mapClass("net.minecraft.world.level.block.Block") {
        method("int", "getId", "net.minecraft.world.level.block.state.BlockState")
    ...
    mapClass("net.minecraft.network.ConnectionProtocol") {
        enumConstant("PLAY")
        field("java.util.Map", "flows") // new, <= 1.20.4
        field("java.util.Map", "packets") // old
    }

    var ConnectionProtocol_PacketSet = mapClass("net.minecraft.network.ConnectionProtocol\$PacketSet") { // <= 1.20.4
        methodChain {
            item("int", "getId", "java.lang.Class")
            item("java.lang.Integer", "getId", "java.lang.Class")
        } // 1.19.4: compatible change - return type changed from boxed Integer to primitive int
    }

    mapClass("net.minecraft.network.ConnectionProtocol\$CodecData") { // 1.20.2-1.20.4
        field(ConnectionProtocol_PacketSet, "packetSet")
    }

    // 1.20.5+ - Registry-backed protocol info
    mapClass("net.minecraft.network.protocol.game.GameProtocols") {
        fieldInferred("CLIENTBOUND_TEMPLATE", "1.21.4") // "net.minecraft.network.ProtocolInfo\$Details"

        // 1.21.5+
        field("net.minecraft.network.protocol.SimpleUnboundProtocol", "CLIENTBOUND_TEMPLATE")
    }
    mapClass("net.minecraft.network.ProtocolInfo") {
        method("net.minecraft.network.codec.StreamCodec", "codec")
    }
    mapClass("net.minecraft.network.ProtocolInfo\$Details") {
        method("net.minecraft.network.ProtocolInfo", "bind", "java.util.function.Function")
    }
    mapClass("net.minecraft.network.protocol.SimpleUnboundProtocol") {
        method("net.minecraft.network.ProtocolInfo", "bind", "java.util.function.Function")
    }
    mapClass("net.minecraft.network.codec.IdDispatchCodec") {
        field("it.unimi.dsi.fastutil.objects.Object2IntMap", "toId")
    }
    mapClass("net.minecraft.network.protocol.PacketType") {
        method("net.minecraft.network.protocol.PacketFlow", "flow")
        method("net.minecraft.resources.Identifier", "id")
    }
    mapClass("net.minecraft.network.codec.StreamEncoder") {
        method("void", "encode", "java.lang.Object", "java.lang.Object")
    }
    mapClass("net.minecraft.network.codec.StreamDecoder") {
        method("java.lang.Object", "decode", "java.lang.Object")
    }
    mapClass("net.minecraft.core.component.DataComponentPatch") {
        field("net.minecraft.network.codec.StreamCodec", "STREAM_CODEC")
    }
    mapClass("net.minecraft.network.RegistryFriendlyByteBuf") {
        constructor("io.netty.buffer.ByteBuf", "net.minecraft.core.RegistryAccess")
    }
    ...
    mapClass("net.minecraft.server.network.ServerCommonPacketListenerImpl") {
        ...
        field("boolean", "suspendFlushingOnServerThread")
        method("void", "send", Packet) // 1.20.2+
    }

    var Tag = mapClass("net.minecraft.nbt.Tag") {
        method("java.util.Optional", "asString")
        method(String::class, "getAsString")
    }
    ...
    mapClass("net.minecraft.nbt.ByteTag") {
        ...
        method(this.name, "valueOf", "byte")
    }

    val CompoundTag = mapClass("net.minecraft.nbt.CompoundTag") {
        constructor()
        method("java.util.Set", "keySet")
        method(Tag, "get", String::class)
        methodChain {
            item("void", "remove", String::class)
            item(Tag, "remove", String::class)
        }

        val cmpTagName = this.name
        methodChain {
            item(Tag, "put", String::class, Tag)
            item("void", "set", String::class, "net.minecraft.server.VVV.NBTBase") // Spigot mapped
        }
        methodChain {
            item(cmpTagName, "merge", cmpTagName)
            item("void", "func_179237_a", "net.minecraft.nbt.NBTTagCompound") // Searge mapped
    ...
    mapClass("net.minecraft.nbt.DoubleTag") {
        ...
        method(this.name, "valueOf", "double") // 1.15+
    }

    mapClass("net.minecraft.nbt.FloatTag") {
        constructor("float")
        method("float", "floatValue")
        method(this.name, "valueOf", "float") // 1.15+
    }
    ...
    mapClass("net.minecraft.nbt.IntTag") {
        constructor("int")
        method("int", "intValue")
        method(this.name, "valueOf", "int") // 1.15+
    }
    ...
    mapClass("net.minecraft.nbt.ListTag") {
        ...
        methodChain {
            item(Tag, "get", "int")
            item("net.minecraft.nbt.NBTBase", "func_179238_g", "int") // Searge mapped
        }
        methodChain {
            item("boolean", "add", "net.minecraft.server.VVV.NBTBase") // Spigot mapped
            item("void", "add", "net.minecraft.server.VVV.NBTBase") // Spigot mapped
        } // <= 1.13.2
    }
    ...
    mapClass("net.minecraft.world.item.ItemStack") {
        ...
        // 1.20.5+
        method("java.util.Optional", "parse", "net.minecraft.core.HolderLookup\$Provider", Tag) // <= 1.21.5
        method(Tag, "save", "net.minecraft.core.HolderLookup\$Provider", Tag)
        method("net.minecraft.core.component.DataComponentPatch", "getComponentsPatch")
        field("com.mojang.serialization.Codec", "CODEC") // 1.21.6+
    }
    ...
    mapClass("net.minecraft.world.entity.monster.zombie.Zombie") {
    ...
    mapClass("net.minecraft.world.entity.animal.equine.Horse") {
    ...
    var AttributeModifier = mapClass("net.minecraft.world.entity.ai.attributes.AttributeModifier") {
        ...
        getter(String::class, "name") // name
        getter("java.util.UUID", "id") // unique id

        constructor("java.util.UUID", String::class, "double", "int")
    }

    mapClass("net.minecraft.world.entity.ai.attributes.AttributeInstance") {
        constructor(Attribute, "java.util.function.Consumer") // <= 1.20.5
        ...
        methodChain {
            item("java.util.Set", "getModifiers")
            item("java.util.Collection", "getModifiers")
        } // get modifiers
    ...
    mapClass("net.minecraft.world.entity.item.PrimedTnt") {
        field(LivingEntity, "owner") // <= 1.16.3
    }

    mapClass("net.minecraft.world.entity.EntityType\$EntityFactory") {
        method(Entity, "create", EntityType, "net.minecraft.world.level.Level")
    }

    mapClass("net.minecraft.world.entity.ExperienceOrb") {
