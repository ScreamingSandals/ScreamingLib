...
package org.screamingsandals.lib.impl.player.gamemode;
...
public abstract class GameModeRegistry extends SimpleRegistry<GameMode> {
    ...
    public GameModeRegistry() {
        ...
        Preconditions.checkArgument(registry == null, "GameModeRegistry is already initialized!");
        registry = this;
    }

    public static @NotNull GameModeRegistry getInstance() {
        return Preconditions.checkNotNull(registry, "GameModeRegistry is not initialized yet!");
    }
}
