...
package org.screamingsandals.lib.impl.block;
...
public abstract class BlockRegistry extends Registry<Block> {
    ...
    private static @Nullable Block cachedAir;
    ...
    public static @NotNull BlockRegistry getInstance() {
        return Preconditions.checkNotNull(registry, "BlockTypeRegistry is not initialized yet!");
    }

    @Override
    protected @Nullable Block resolveMapping0(@NotNull Object object) {
    ...
    public static @NotNull Block colorize(@NotNull Block holder, @NotNull String color) {
    ...
    public static @NotNull Block getCachedAir() {
        if (cachedAir == null) {
    ...
    protected abstract @Nullable Block resolveMappingPlatform(@NotNull ResourceLocation location, @Nullable String blockState);
}
