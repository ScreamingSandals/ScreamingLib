...
public class ParticleTypeSerializer implements TypeSerializer<ParticleType> {
    public static final @NotNull ParticleTypeSerializer INSTANCE = new ParticleTypeSerializer();
