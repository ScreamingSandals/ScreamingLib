...
public class ItemMeta {
    ...
    // Fireworks
    public static final MetadataCollectionKey<FireworkEffect> FIREWORK_EFFECTS = MetadataCollectionKey.of("Fireworks.Explosions", FireworkEffect.class);
    public static final MetadataKey<Integer> FIREWORK_POWER = MetadataKey.of("Fireworks.Flight", Integer.class);

    // Firework star
    public static final MetadataKey<FireworkEffect> FIREWORK_STAR_EFFECT = MetadataKey.of("Explosion", FireworkEffect.class);
