...
package org.screamingsandals.lib.impl.block.tags;
...
public class ModernBlockTagBackPorts {
    public static @Nullable List<@NotNull String> getPortedTags(@NotNull Block blockType, @NotNull Predicate<@NotNull String> nativeTagChecker) {
