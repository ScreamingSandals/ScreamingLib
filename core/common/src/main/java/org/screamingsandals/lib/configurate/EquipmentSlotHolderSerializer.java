...
public class EquipmentSlotHolderSerializer extends AbstractScreamingSerializer implements TypeSerializer<EquipmentSlotHolder> {
    ...
    @Override
    public @NotNull EquipmentSlotHolder deserialize(@NotNull Type type, @NotNull ConfigurationNode node) throws SerializationException {
        try {
    ...
    @Override
    public void serialize(@NotNull Type type, @Nullable EquipmentSlotHolder obj, @NotNull ConfigurationNode node) throws SerializationException {
