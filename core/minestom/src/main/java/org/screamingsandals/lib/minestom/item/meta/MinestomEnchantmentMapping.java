...
public class MinestomEnchantmentMapping extends EnchantmentMapping {
    public MinestomEnchantmentMapping() {
        enchantmentConverter
                .registerW2P(Enchantment.class, e -> Enchantment.fromNamespaceId(e.platformName()))
                .registerP2W(Enchantment.class, MinestomEnchantmentHolder::new);

        Enchantment.values().forEach(enchantment -> {
            final var holder = new MinestomEnchantmentHolder(enchantment);
