...
public class BukkitProfessionRegistry1_14 extends ProfessionRegistry {
    ...
    protected @NotNull RegistryItemStream<@NotNull Profession> getRegistryItemStream0() {
        return BukkitRegistry.registryStream(Registry.VILLAGER_PROFESSION, BukkitProfession1_14::new);
    }

    @Override
    protected @Nullable Profession resolveMappingPlatform(@NotNull ResourceLocation location) {
        return BukkitRegistry.tryObtainItem(Registry.VILLAGER_PROFESSION, BukkitProfession1_14::new, location);
    }
}
