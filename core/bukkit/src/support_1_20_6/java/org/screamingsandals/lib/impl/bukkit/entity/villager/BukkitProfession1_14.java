...
public class BukkitProfession1_14 extends BasicWrapper<Villager.Profession> implements Profession {

    public BukkitProfession1_14(@NotNull Villager.Profession wrappedObject) {
        super(wrappedObject);
    }
