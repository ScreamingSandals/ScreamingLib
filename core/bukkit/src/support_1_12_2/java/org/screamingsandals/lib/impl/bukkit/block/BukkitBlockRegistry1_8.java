...
import org.screamingsandals.lib.impl.bukkit.compat.v1_12_2.BukkitLegacyBlockTagResolution;
...
public class BukkitBlockRegistry1_8 extends BlockRegistry {
    ...
    public BukkitBlockRegistry1_8() {
        ...
        Arrays.stream(Material.values())
                ...
                .forEach(material -> {
                    var backPorts = BukkitLegacyBlockTagResolution.constructTags(material);
