...
public class BukkitEntityAirChangeEvent implements EntityAirChangeEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.entity.EntityAirChangeEvent event;
