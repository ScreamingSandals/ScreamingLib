...
public class BukkitPlayerWorldChangeEvent implements PlayerWorldChangeEvent {
    @Getter
    ...
    @Override
    public @NotNull World from() {
        if (from == null) {
            from = Worlds.wrapWorld(event.getFrom());
        }
        return from;
    }
}
