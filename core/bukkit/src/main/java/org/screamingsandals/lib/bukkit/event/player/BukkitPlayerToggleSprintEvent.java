...
public class BukkitPlayerToggleSprintEvent implements PlayerToggleSprintEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.player.PlayerToggleSprintEvent event;
