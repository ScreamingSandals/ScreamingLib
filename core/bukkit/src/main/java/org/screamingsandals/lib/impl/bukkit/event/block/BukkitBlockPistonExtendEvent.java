...
public class BukkitBlockPistonExtendEvent extends BukkitBlockPistonEvent implements BlockPistonExtendEvent {

    // Internal cache
    private @Nullable Collection<@NotNull BlockPlacement> pushedBlocks;

    public BukkitBlockPistonExtendEvent(@NotNull org.bukkit.event.block.BlockPistonExtendEvent event) {
        super(event);
    }
    ...
    public @NotNull Collection<@NotNull BlockPlacement> pushedBlocks() {
        if (pushedBlocks == null) {
            pushedBlocks = new CollectionLinkedToCollection<>(((org.bukkit.event.block.BlockPistonExtendEvent) event()).getBlocks(), o -> o.as(org.bukkit.block.Block.class), BukkitBlockPlacement::new);
        }
        return pushedBlocks;
    }
}
