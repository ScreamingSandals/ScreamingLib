...
public class BukkitProfession1_21 extends BasicWrapper<Villager.Profession> implements Profession {

    public BukkitProfession1_21(@NotNull Villager.Profession wrappedObject) {
        super(wrappedObject);
    }
