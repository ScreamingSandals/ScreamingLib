...
public class BukkitAttributeTypeRegistry1_21_2 extends AttributeTypeRegistry {
    public BukkitAttributeTypeRegistry1_21_2() {
        specialType(Attribute.class, BukkitAttributeType1_21_2::new);
    }

    @Override
    protected @NotNull RegistryItemStream<@NotNull AttributeType> getRegistryItemStream0() {
        return BukkitRegistry.registryStream(Registry.ATTRIBUTE, BukkitAttributeType1_21_2::new);
    }

    @Override
    protected @Nullable AttributeType resolveMappingPlatform(@NotNull ResourceLocation location) {
        return BukkitRegistry.tryObtainItem(Registry.ATTRIBUTE, BukkitAttributeType1_21_2::new, location);
    }
}
