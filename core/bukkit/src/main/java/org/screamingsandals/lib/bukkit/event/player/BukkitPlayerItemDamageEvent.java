...
public class BukkitPlayerItemDamageEvent implements PlayerItemDamageEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.player.PlayerItemDamageEvent event;
