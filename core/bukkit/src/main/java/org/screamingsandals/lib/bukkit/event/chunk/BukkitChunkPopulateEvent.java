...
import org.screamingsandals.lib.bukkit.world.chunk.BukkitChunk;
...
public class BukkitChunkPopulateEvent implements ChunkPopulateEvent {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.world.ChunkPopulateEvent event;
