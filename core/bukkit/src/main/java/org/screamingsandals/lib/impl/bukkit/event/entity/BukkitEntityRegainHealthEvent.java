...
public class BukkitEntityRegainHealthEvent implements EntityRegainHealthEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.entity.EntityRegainHealthEvent event;
    ...
    @Override
    public @NotNull RegainReason remainingReason() {
        if (reason == null) {
