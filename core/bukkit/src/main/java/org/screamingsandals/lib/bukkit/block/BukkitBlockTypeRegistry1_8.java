...
public class BukkitBlockTypeRegistry1_8 extends BukkitBlockTypeRegistry {
    private static final @NotNull Map<@NotNull Material, List<String>> tagBackPorts = new HashMap<>();
    @Getter
    protected final @NotNull Map<@NotNull ResourceLocation, @NotNull BukkitBlockType1_8> ports = new HashMap<>();
    @Getter
    protected final @NotNull Map<@NotNull BukkitBlockType1_8, @NotNull ResourceLocation> resourceLocations = new HashMap<>();

    public BukkitBlockTypeRegistry1_8() {
        specialType(Material.class, mat -> mat.isBlock() ? new BukkitBlockType1_8(mat) : null);
        specialType(MaterialData.class, data -> data.getItemType().isBlock() ? new BukkitBlockType1_8(data) : null);
    ...
    @Override
    protected @NotNull RegistryItemStream<@NotNull BlockType> getRegistryItemStream0() {
    ...
    @Override
    protected @Nullable BlockType resolveMappingPlatform(@NotNull ResourceLocation location, @Nullable String blockState) {
    ...
    private @Nullable BlockType resolveMappingPlatform(@NotNull ResourceLocation location) {
        ...
        if ("minecraft".equals(namespace)) {
            if (path.startsWith("legacy/")) {
                ...
                try {
                    ...
                    return new BukkitBlockType1_8(value, (byte) dataValue);
                ...
                if (mat instanceof Material && ((Material) mat).isBlock()) {
                    return new BukkitBlockType1_8((Material) mat, (byte) dataValue);
                }
            }
        } else {
            ...
            if (dataSectionIndex != -1) {
                ...
                try {
                    ...
                    return new BukkitBlockType1_8(value);
                } catch (IllegalArgumentException ignored) {
                }
