...
public class BukkitPlayerGameModeChangeEvent implements PlayerGameModeChangeEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.player.PlayerGameModeChangeEvent event;
