...
public class BukkitBlockFadeEvent implements BlockFadeEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.block.BlockFadeEvent event;
    ...
    public @NotNull BlockSnapshot newBlockState() {
        if (newBlockState == null) {
            newBlockState = BlockSnapshots.<BlockSnapshot>wrapBlockState(event.getNewState()).orElseThrow();
        }
