...
public class BukkitExplosionPrimeEvent implements ExplosionPrimeEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.entity.ExplosionPrimeEvent event;
