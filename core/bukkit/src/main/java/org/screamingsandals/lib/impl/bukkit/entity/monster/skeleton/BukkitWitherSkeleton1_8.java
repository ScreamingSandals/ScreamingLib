...
public class BukkitWitherSkeleton1_8 extends BukkitMonster implements WitherSkeleton {
    public BukkitWitherSkeleton1_8(@NotNull org.bukkit.entity.Skeleton wrappedObject) {
        super(wrappedObject);
    }
}
