...
public class BukkitPlayerToggleFlightEvent implements PlayerToggleFlightEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.player.PlayerToggleFlightEvent event;
