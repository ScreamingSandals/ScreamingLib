...
public class BukkitPlayerDropItemEvent implements PlayerDropItemEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.player.PlayerDropItemEvent event;

    // Internal cache
    private @Nullable Player player;
    private @Nullable ItemEntity itemDrop;
    ...
    @Override
    public @NotNull ItemEntity itemDrop() {
        if (itemDrop == null) {
            itemDrop = new BukkitItemEntity(event.getItemDrop());
        }
        return itemDrop;
    }
}
