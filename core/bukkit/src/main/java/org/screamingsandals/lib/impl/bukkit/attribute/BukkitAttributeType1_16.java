...
public class BukkitAttributeType1_16 extends BasicWrapper<Attribute> implements AttributeType {

    public BukkitAttributeType1_16(@NotNull Attribute wrappedObject) {
        super(wrappedObject);
    }
