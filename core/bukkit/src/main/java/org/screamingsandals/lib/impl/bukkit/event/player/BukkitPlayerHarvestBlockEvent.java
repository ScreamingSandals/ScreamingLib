...
public class BukkitPlayerHarvestBlockEvent implements PlayerHarvestBlockEvent, BukkitCancellable {
    @Getter
    @EqualsAndHashCode.Include
    @ToString.Include
    private final @NotNull org.bukkit.event.player.PlayerHarvestBlockEvent event;

    // Internal cache
    private @Nullable Player player;
    private @Nullable Collection<@NotNull ItemStack> itemsHarvested;
    private @Nullable BlockPlacement harvestedBlock;
    ...
    @Override
    public @NotNull Collection<@NotNull ItemStack> itemsHarvested() {
    ...
    @Override
    public @NotNull BlockPlacement harvestedBlock() {
        if (harvestedBlock == null) {
            harvestedBlock = new BukkitBlockPlacement(event.getHarvestedBlock());
        }
