...
public interface CraftPersistentDataContainerAccessor {
    @NotNull Supplier<@Nullable Class<?>> TYPE = LazySupplier.of(() -> Reflect.getClassSafe(ClassStorage.CB_PACKAGE + ".persistence.CraftPersistentDataContainer"));
