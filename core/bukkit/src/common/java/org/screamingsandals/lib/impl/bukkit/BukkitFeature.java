...
public class BukkitFeature {
    ...
    public static final @NotNull PlatformFeature FLOWER_POT_BLOCK_STATE = PlatformFeature.of(() -> Reflect.has("org.bukkit.block.FlowerPot"));
    ...
    public static final @NotNull PlatformFeature UNSAFE_VALUES_DATA_VERSION = PlatformFeature.of(() -> Reflect.hasMethod(UnsafeValues.class, "getDataVersion"));
