...
package org.screamingsandals.lib.impl.bukkit.compat.v1_8_8.bossbar;
...
import org.screamingsandals.lib.impl.nms.accessors.network.syncher.SynchedEntityDataAccessor;
...
public class FakeEntityNMS<E extends Entity> implements Listener {
    ...
    public void addViewer(@NotNull Player viewer) {
        if (viewers.isEmpty()) {
            Bukkit.getPluginManager().registerEvents(this, JavaPlugin.getProvidingPlugin(FakeEntityNMS.class));
        }
