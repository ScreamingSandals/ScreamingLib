package org.screamingsandals.lib.core.nms.utils;
...
public class ClassStorage {
	...
	public static Class<?> getNMSClassSafe(String... clazz) {
		return SReflect.getClassSafe(Map.of("{obc}", "org.bukkit.craftbukkit." + NMS_VERSION, "{nms}", "net.minecraft.server." + NMS_VERSION,
	...
	public static Object getHandle(Object obj) {
		return SReflect.fastInvoke(obj, "getHandle");
	}
	
	public static Object getPlayerConnection(Player player) {
		var handler = SReflect.fastInvoke(player, "getHandle");
		if (handler != null) {
			return SReflect.getField(handler, "playerConnection,field_71135_a");
		}
		return null;
	}
	...
	public static boolean sendPacket(Player player, Object packet) {
		...
		if (connection != null) {
			SReflect.getMethod(connection, "sendPacket,func_147359_a", NMS.Packet).invoke(packet);
			return true;
		}
		return false;
	}
	...
	public static Object getMethodProfiler(Object handler) {
		var methodProfiler = SReflect.fastInvoke(handler, "getMethodProfiler,func_217381_Z");
		if (methodProfiler == null) {
			methodProfiler = SReflect.getField(handler, "methodProfiler,field_72984_F");
		}
	...
	public static Object obtainNewPathfinderSelector(Object handler) {
		try {
			var world = SReflect.fastInvoke(handler, "getWorld,func_130014_f_");
			try {
				// 1.16
