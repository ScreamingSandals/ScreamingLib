...
inline fun <K : Event> K.fire(): K = EventManager.fire(this)
inline infix fun <K : Event> K.fire(manager: EventManager): K = manager.fireEvent(this)

inline fun <K : Event> K.fireAsync(): CompletableFuture<K> = EventManager.fireAsync(this)
inline infix fun <K : Event> K.fireAsync(manager: EventManager): CompletableFuture<K> = manager.fireEventAsync(this)
